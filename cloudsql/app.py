...
st.set_page_config(layout="wide" ,
                   page_title="Oracle ERP Cloud SQL",
                   page_icon="🗄️",
...
def main():
    ...
    st.markdown("""
        <div class="main-header">
            <h1>🗄️ Oracle ERP Cloud SQL Console</h1>
            <p>Execute SQL queries against Oracle ERP Cloud with ease</p>
        </div>
    """, unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        username_input = st.text_input('Username', value=username, help="Your Oracle ERP username")
